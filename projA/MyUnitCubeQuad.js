class MyUnitCubeQuad extends CGFobject {
    ...
    initMaterials(scene,topTexture,sideTexture,bottomTexture) {
        ...
        this.sideTex.setDiffuse(1.0, 1.0, 1.0, 1.0);
        this.sideTex.setSpecular(0.0, 0.0, 0.0, 1.0);
        ...
        this.topTex.setDiffuse(1.0, 1.0, 1.0, 1.0);
        this.topTex.setSpecular(0.0, 0.0, 0.0, 1.0);
        ...
        this.bottomTex.setDiffuse(1.0, 1.0, 1.0, 1.0);
        this.bottomTex.setSpecular(0.0, 0.0, 0.0, 1.0);
